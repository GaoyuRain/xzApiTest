...
class AlarmConfig:
    ...
    # fn_message = MessageUtils.get_fn_message(1519587489402150912, 10006)
    # fn_message = MessageUtils.get_fn_message(1514157347660492800, 15)
    fn_message = MessageUtils.get_fn_message(1514157346441248768, 101)
    apm_message01 = MessageUtils.get_apm_message(1495996855845318656, 7004)
...
if __name__ == '__main__':
    ...
    # send_kfmsg(AlarmConfig.fn_config01)
    # time.sleep(2)
